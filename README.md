...
You can also test the web application online by clicking [here](https://www.holbertonsurvivors.com/). 
...
<table>
    ...
    <tr valign="top">
        <td align="center">
            <img src="./assets/images/screenshot_page.png">
        </td>
        <td align="center">
...
- Reimplement the parallax effect on the logo in the download section.
